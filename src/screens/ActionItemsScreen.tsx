...
const ActionItemCard: React.FC<ActionItemCardProps> = ({
  ...
  const panResponder = PanResponder.create({
    ...
    onMoveShouldSetPanResponder: (_, gestureState) => {
      return !desktop && Math.abs(gestureState.dx) > 10;
    },
  ...
  return (
    <View style={styles.cardWrapper} {...(!desktop ? panResponder.panHandlers : {})}>
      <Animated.View 
        style={[
          styles.itemCard,
        ...
        onMouseEnter={() => desktop && setIsHovered(true)}
        onMouseLeave={() => desktop && setIsHovered(false)}
      >
        <TouchableOpacity
          style={styles.itemHeader}
          onPress={() => onToggleComplete(item.id)}
          onLongPress={handleLongPress}
          onPress={desktop ? handleDesktopClick : () => onToggleComplete(item.id)}
          activeOpacity={0.7}
          delayLongPress={500}
        >
          <Ionicons
          ...
          {desktop && isHovered && (
            <View style={styles.itemActions}>
              ...
              >
                ...
                <Text style={{ fontSize: 12, marginLeft: 4 }}>Edit</Text>
              </TouchableOpacity>
              <TouchableOpacity
              ...
              >
                ...
                <Text style={{ fontSize: 12, marginLeft: 4, color: '#fff' }}>Delete</Text>
              </TouchableOpacity>
            </View>
          )}
          {/* Mobile gesture hint */}
